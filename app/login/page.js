...
//                 <h1 className='text-2xl font-bold'>SignUp to Get Started</h1>

//                 <div className='flex flex-col gap-3'>

//                     <input className='px-4 py-2 focus:outline-purple-600 rounded-md' type="text" placeholder='name' onChange={handleChange} />
//                     <input className='px-4 py-2 focus:outline-purple-600 rounded-md' type="email" placeholder='email' onChange={handleChange} />
//                     <input className='px-4 py-2 focus:outline-purple-600 rounded-md' type="password" placeholder='password' onChange={handleChange}/>

//                     <button className='bg-purple-500 shadow-lg rounded-lg font-bold py-1 p-3 my-3 text-white' onClick={() => signIn(user.name, user.email, user.password)}>Signup</button>
//                 </div>
//             </div>
//         </div>
//     )
...
const page = () => {
    ...
    return (
        <div className='mx-auto max-w-lg bg-purple-100 my-16 p-8 flex flex-col gap-3 justify-center items-center rounded-md'>
    

            <h2 className='font-bold text-2xl my-6'>Signup to Get Started</h2>
